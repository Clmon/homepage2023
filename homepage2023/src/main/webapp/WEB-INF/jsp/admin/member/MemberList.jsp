...
<div class="container">
	<div id="contents">
		...
		<div id="bbs_wrap">
			<div class="total">
				총 게시물
				<strong><c:out value="${pagenationInfo.totalRecordCount}" /></strong> 건 |
				현제페이지 <strong><c:out value="${pagination.currentPageNo}" /></strong> /
				...
				<table class="list_table">
					...
					<tbody>
						<c:forEach var="result" items="${resultList}" varStatus="status">
							<tr>
								<td><c:out value="${paginationInfo.totalRecordCount - ((searchVO.pageIndex-1) * searchVO.pageUnit) - (status.count - 1)}"></c:out></td>
								<td><c:out value="${result.emplyrId}"></c:out></td>
