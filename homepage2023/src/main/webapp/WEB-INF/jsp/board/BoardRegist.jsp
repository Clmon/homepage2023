				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<input type="radio" id="othbcAtY" value="Y" name="othbcAt" <c:if test="${result.noticeAt eq 'Y'}">checked="chedcked"</c:if>/>
							&nbsp;&nbsp;&nbsp;
							<label for="othbcAtN">아니오 : </label>
							<input type="radio" id="othbcAtN" value="N" name="othbcAt" <c:if test="${result.noticeAt ne 'Y'}">checked="chedcked"</c:if>/>
						</td>
					</tr>
					<tr>
